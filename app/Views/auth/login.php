...
<div class="w-full flex justify-center min-h-screen">
    <div class="h-screen w-full">
        <div class="flex item-center justify-center">
            <div
                 class="relative z-10 mt-[calc(25vh)] md:mt-[calc(30vh)] h-fit w-full max-w-lg mx-6 md:mx-0 overflow-hidden border border-vulcan-500 rounded-2xl shadow-xl">
                <div
                    ...
                    <!-- <a href="/">
                        <img data-nimg="1" src="/brand.svg" alt="DeepStream" style="color: transparent;" fetchpriority="high" width="48" height="48" decoding="async">
                    </a>  -->
                ...
                <div
                    ...
                    <p class="text-center text-sm text-slate-300/80">Belum punya akun?
                        <a class="font-semibold text-blue-400 transition-colors hover:text-blue-300" href="/auth/register">Daftar Sekarang</a>.
                    </p>
                </div>
            </div>
        </div>

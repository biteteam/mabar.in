...
<div class="w-full flex justify-center min-h-screen overflow-x-hidden overflow-y-auto">
    <div class="h-screen w-full">
        <div class="flex item-center justify-center py-[calc(10vh)]">
            <div class="relative z-10 h-fit w-full max-w-lg mx-6 md:mx-0 overflow-hidden border border-vulcan-500 rounded-2xl shadow-xl">
                <div
                    ...
                    <h3 class="text-xl font-semibold">Daftar ke <?= env('app.name', 'MabarIn') ?></h3>
                    <p class="text-sm text-slate-300">Daftar sekarang dan temukan tim mabar di banyak game yang solid.</p>
                </div>
                <div
                    ...
                    <form class="flex flex-col" action="<?= url_to('register') ?>" method="post" accept-charset="utf-8">
                        <div class="mb-5">
                            <?= view_cell('InputCell', [
                                'name' => 'name',
                                'label' => 'Nama',
                    ...
                    <p class="text-center text-sm text-slate-300/80">Sudah punya akun?
                        <a class="font-semibold text-blue-400 transition-colors hover:text-blue-300" href=<?= url_to('login') ?>>Login</a>.
                    </p>
                </div>
            </div>
        </div>

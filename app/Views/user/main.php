                ...
                <tbody class="bg-slate-800">
                    ...
                    <tr class="border-b bg-vulcan-800/80 border-vulcan-700 hover:bg-vulcan-700 hover:border-vulcan-600">
                        ...
                        <th class="flex items-center px-6 py-4 whitespace-nowrap text-white" scope="row">
                            ...
                            <div class="ps-3">
                                <div class="text-base font-semibold text-slate-100"><?= esc($user->name) ?></div>
                                <a class="font-medium text-slate-300/70 hover:text-blue-400 cursor-pointer"
                        ...
                        <td class="px-6 py-4">
                            <a class="font-medium text-blue-400 hover:underline" href="#">Edit</a>
                        </td>
                    </tr>
                    <?php endforeach ?>
                </tbody>

            ...
            <form class="flex flex-col w-full  px-4 py-6 md:px-8 md:pt-8 md:pb-10" action="<?= url_to('team.edit', $team->code) ?>" method="post"
                ...
                <div class="mb-5">
                    <?= view_cell('InputGameCell', [
                        ...
                        'value' => set_value('team_game', $team->game->id),
                ...
                <div class="mb-5">
                    <?= view_cell('InputCell', [
                        ...
                        'value' => set_value('team_name', $team->name),
                ...
                <div class="mb-5">
                    <?= view_cell('InputCell', [
                        ...
                        'value' => set_value('team_code', $team->code),
                        'errorMessage' => !empty($error->team_code) ? $error->team_code : null,
                    ]) ?>
                </div>
                <?php if(($team->status == 'draft' || $team->status == 'recruite') && count($team->members) < 1): ?>
                <div class="mb-8">
                    <?= view_cell('InputCell', [
                        'name' => 'team_status',
                        'label' => 'Status Tim',
                        ...
                        'mathParentSlug' => null,
                        'value' => set_value('team_status', $team->status),

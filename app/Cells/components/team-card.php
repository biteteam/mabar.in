                                 ...
                                 <div class="flex flex-col w-full p-2 pr-3 hover:py-2 hover:px-3">
                                     ...
                                     <div class="flex flex-row w-full gap-2 items-center">
                                         ...
                                         <div class="flex flex-col text-start z-10 max-w-[80%]">
                                             ...
                                             <span class="text-xs text-slate-300">@<?= $member->account->user->username ?></span>
                                         </div>
                                     </div>
                                     <div toggle-expand="<?= "team-{$team->id}-member-{$member->id}" ?>" show-on-toggle="true" class="hidden flex-col px-1 text-start mt-2 py-1 border-t border-vulcan-600">
